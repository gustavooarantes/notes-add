    ...
    return (
        <div>
            ...
            <div className="flex items-center gap-4 mt-3">
                ...
                <button className="w-8 h-8 flex items-center justify-center rounded border border-blue-700"> <MdAdd className="text-2xl text-blue-700" onClick={() => {addNewTag();}} /> </button>
            </div>
        </div>
    )
}
